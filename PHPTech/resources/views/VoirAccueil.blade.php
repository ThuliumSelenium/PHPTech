...
<div class="slide-one-item home-slider owl-carousel">
      ...
      <div class="site-blocks-cover overlay" style="background-image: url(images/felixCAMPUS.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
        <div class="container">
          <div class="row align-items-center justify-content-center text-center">
            <div class="col-md-10">
              <h1 class="mb-5">Félix Leclerc</h1>           
              <p>
                <a href="http://www.cegepoutaouais.qc.ca/index.php/campus-felix-leclerc" class="btn btn-white btn-outline-white py-3 px-5 rounded-0">Visiter la page du campus</a>
              </p>
            </div>
          </div>
        </div>
      ...
      <div class="site-blocks-cover overlay" style="background-image: url(images/gabCAMPUS.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
        <div class="container">
          <div class="row align-items-center justify-content-center text-center">
            <div class="col-md-10">
              <h1 class="mb-5">Gabrielle Roy</h1>
              <p>
                <a href="http://www.cegepoutaouais.qc.ca/index.php/campus-gabrielle-roy" class="btn btn-white btn-outline-white py-3 px-5 rounded-0">Visiter la page du campus</a>
              </p>
            </div>
          </div>
        </div>
      ...
      <div class="site-blocks-cover overlay" style="background-image: url(images/LOUISREBOULCAMPUS.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
        <div class="container">
          <div class="row align-items-center justify-content-center text-center">
            <div class="col-md-10">
              <h1 class="mb-5">LOUIS-REBOUL</h1>
              <p>
                <a href="http://www.cegepoutaouais.qc.ca/index.php/campus-louis-reboul" class="btn btn-white btn-outline-white py-3 px-5 rounded-0">Visiter la page du campus</a>
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="container">
          <div class="row align-items-center text-left">
            <div class="col-md-7">
              ...
              <p>
                <a href="#" class="btn btn-primary py-3 px-5 rounded-0">Register Now</a>
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="row hosting">
          <div class="col-md-6 col-lg-4 mb-5 mb-lg-0" data-aos="fade" data-aos-delay="100">
            ...
            <div class="unit-2 text-center border py-5 h-100 bg-white">
              ...
              <p class="mb-4 text-gray-500">Plans start at $3.99/month</p>
          ...
          <div class="col-md-6 col-lg-4 mb-5 mb-lg-0" data-aos="fade" data-aos-delay="200">
            ...
            <div class="unit-2 text-center border py-5 h-100 bg-white">
              ...
              <p class="mb-4 text-gray-500">Plans start at $6.99/month</p>
              <p><a href="#" class="btn btn-primary py-2 px-4 rounded-0">View Details</a></p>
            </div>
          ...
          <div class="col-md-6 col-lg-4 mb-5 mb-lg-0" data-aos="fade" data-aos-delay="300">
            ...
            <div class="unit-2 text-center border py-5 h-100 bg-white">
              ...
              <p class="mb-4 text-gray-500">Plans start at $9.99/month</p>
              <p><a href="#" class="btn btn-primary py-2 px-4 rounded-0">View Details</a></p>
            </div>
          ...
          <div class="col-md-6 col-lg-4 mb-5 mb-lg-4" data-aos="fade" data-aos-delay="100">
            ...
            <div class="unit-3 h-100 bg-white">
              ...
              <div class="d-flex align-items-center mb-3 unit-3-heading">
                ...
                <h2 class="h5">High Quality Hardware</h2>
              </div>
          ...
          <div class="col-md-6 col-lg-4 mb-5 mb-lg-4" data-aos="fade" data-aos-delay="200">
            ...
            <div class="unit-3 h-100 bg-white">
              ...
              <div class="d-flex align-items-center mb-3 unit-3-heading">
                ...
                <h2 class="h5">Top Data Centers</h2>
              </div>
              <div class="unit-3-body">
                <p>Lorem ipsum dolor sit amet consectetur is a nice adipisicing elita ssumenda a similique perferendis dolorem eos.</p>
              </div>
          ...
          <div class="col-md-6 col-lg-4 mb-5 mb-lg-4" data-aos="fade" data-aos-delay="300">
            ...
            <div class="unit-3 h-100 bg-white">
              ...
              <div class="d-flex align-items-center mb-3 unit-3-heading">
                ...
                <h2 class="h5">Outstanding Speed</h2>
              </div>
              <div class="unit-3-body">
                <p>Lorem ipsum dolor sit amet consectetur is a nice adipisicing elita ssumenda a similique perferendis dolorem eos.</p>
              </div>
